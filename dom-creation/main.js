...
function renderPokemon(pokemon) {
  ...
  var divHeading2 = document.createElement('h2');
  divHeading2.textContent = pokemon.name;
  divPokemonCardText.appendChild(divHeading2);

  var divHeading3 = document.createElement('h3');
  divHeading3.textContent = '#' + pokemon.number;
  divPokemonCardText.appendChild(divHeading3);

  var paragraphDescription = document.createElement('p');
  paragraphDescription.textContent = pokemon.description;
  divPokemonCardText.appendChild(paragraphDescription);
